  ...
  const divisions: Division[] = [
    {
      ...
      capabilities: ["Planetary Monitoring", "Weather Analysis", "Satellite Uplink", "Disaster Forecast", "Energy Grid Opt"]
    },
    {
      id: "enid",
    ...
    },
    {
      ...
      capabilities: ["Yield Optimize", "Smart Treasury", "Risk Scoring", "Instant Pay", "Insurance Trigger"]
    },
    {
      id: "hid",
