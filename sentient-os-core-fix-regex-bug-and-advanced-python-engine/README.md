...
*   **Interactive Observations**: Clickable division capabilities providing detailed status reports.
...
To deploy the entire AEOS stack (Frontend + Python Backend) using Docker:
